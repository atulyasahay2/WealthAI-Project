...
# ---------------------------------------------------------
# PASTE YOUR KEY HERE
GEMINI_API_KEY = "AIzaSyALSXwCjMedbOPQR8dYNMceS2kIMJL8-v4" 
...
def retrieve_context(query, top_k=3):
    if knowledge_base.empty: return ""
...
def query_gemini(prompt, context):
    ...
    if not model:
        return "⚠️ API Error: No working Gemini model found. Did you run 'pip install --upgrade google-generativeai'?"
